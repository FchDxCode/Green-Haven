...
from analytics.models import CustomEvent, ComplianceLog
...
class ImageDestinationsInline(admin.TabularInline):
...
class ImageDestinationsAdmin(ModelAdmin):
    list_display = ('destinations', 'image', 'created_at')
    list_filter = ('created_at', 'updated_at')
    ...
    def save_model(self, request, obj, form, change):
        ...
        event_name = 'destination_image_updated' if change else 'destination_image_added'
